    ...
    return __generator(this, function (_e) {
      switch (_e.label) {
        ...
        case 6:
          ...
          newAggregatedUuid =
            (_d = group.uuidsFromOldRecords.values().next().value) !== null &&
            _d !== void 0
              ? _d
              : "migrated-"
                  .concat(group.userId.toString(), "-")
                  .concat(group.dict, "-")
                  .concat(group.word, "-")
                  .concat(Date.now());
          latestLastModified =
            group.allLastModified.length > 0
              ? Math.max.apply(Math, group.allLastModified)
              : Date.now();
          newRecordData = {
        ...
        case 8:
          ...
          return [3 /*break*/, 11];
        case 9:
          return [4 /*yield*/, WordRecord_1.default.create(newRecordData)];
        case 10:
          _e.sent();
          console.log(
            "\u4E3A\u5206\u7EC4 ".concat(
        ...
        case 11:
          // 标记该组内的旧记录ID以便删除
          group.flatEntries.forEach(function (oldEntry) {
            return idsOfOldRecordsToDelete_1.push(oldEntry._id);
          });
          return [3 /*break*/, 13];
        case 12:
          error_2 = _e.sent();
        ...
        case 14:
          ...
          console.log(
            "\u51C6\u5907\u5220\u9664 ".concat(
              idsOfOldRecordsToDelete_1.length,
              " \u6761\u65E7\u7248\u6241\u5E73\u5316\u8BB0\u5F55..."
            )
          );
          return [
            4 /*yield*/,
            WordRecord_1.default.deleteMany({
              _id: { $in: idsOfOldRecordsToDelete_1 },
            }),
          ];
        case 15:
