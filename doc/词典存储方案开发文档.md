...
官方词库在 mongoDB 的表名：`officialwordlibraries`；
单条记录示例：
{
"\_id": {
...
class DictionaryUploadService {
  ...
  async processWordUpload(
    ...
    // 1. 批量词汇补充
    const enrichmentResults = await this.wordEnrichmentService.batchEnrichWords(
      words
    );
        ...
        <div className="modal-body">
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, usphone: e.target.value })
                  }
                  placeholder="请输入美式音标"
                />
              </div>
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, ukphone: e.target.value })
                  }
                  placeholder="请输入英式音标"
                />
              </div>
          ...
          <TranslationEditor
            ...
            onChange={(translations) =>
              setFormData({ ...formData, detailed_translations: translations })
            }
          />
        </div>
