  ...
  return (
    <>
      <div
        ...
        className={`w-max cursor-pointer rounded border-2 border-dashed border-gray-300 p-1.5 indent-0 text-sm font-bold text-gray-500 transition-all hover:border-indigo-500 hover:text-blue-500
        dark:text-gray-300
        ${className}`}
      >
