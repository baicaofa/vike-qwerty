  ...
  return (
    <div className="flex  w-screen flex-col">
      <section className="flex items-center justify-center py-2 shadow-md">
        ...
        <h1 className="text-2xl font-bold text-primary">Keybr</h1>
      </section>
        ...
        <div className="absolute top-10  flex w-full  flex-col items-center justify-center">
          ...
          <h2
            ...
            style={{
              ...
              animation:
                "typing 3s steps(50), blink-caret 0.75s step-end 4, hideCaret 0s 3s forwards",
            }}
          >
      ...
      <section className="mt-4 px-10">
        <div
          style={{
            boxShadow:
              "0px 0px 12px rgba(0,0,0,0.12), 0px 8px 15px -3px rgba(0,0,0,0.1)",
            borderRadius: "8px",
            overflow: "hidden",
          }}
        >
        ...
        <div className="mt-10">
          {detail.map((item, index) => {
            return (
              <div
                key={index}
                className={`my-4 rounded-2xl px-6 py-5 ${
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(-45deg, #6366f1, #6366f1, #6366f1, #b600ff)",
      ...
      >
        ...
        <h2 className="mt-10    px-10 text-white">
          为键盘工作者设计的单词与肌肉记忆锻炼软件
        </h2>
        <div className="mt-10 rounded-2xl bg-white px-6 py-3 font-bold text-primary">
          请使用桌面端浏览器访问本网站，即刻体验！
        </div>
      </section>
    </div>
