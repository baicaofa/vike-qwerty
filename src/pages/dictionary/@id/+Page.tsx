...
export default function Page({ pageContext }: Props) {
  ...
  console.log('Page pageContext:', pageContext) // 打印整个 pageContext
  console.log('Title from onBeforeRender:', pageContext?.title)
  console.log('Description from onBeforeRender:', pageContext?.description)
  console.log('Meta from onBeforeRender:', pageContext?.meta)
