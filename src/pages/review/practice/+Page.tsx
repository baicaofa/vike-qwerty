      ...
      <div className="flex flex-col h-screen">
        ...
        <div className="flex items-center justify-center flex-1">
          <div className="text-center">
            ...
            <p className="text-gray-600 font-medium">{t("review:status.loading")}</p>
            <p className="text-gray-500 text-sm mt-2">{t("review:practice.preparingWords")}</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="flex flex-col h-screen">
        ...
        <div className="flex items-center justify-center flex-1">
          <div className="text-center max-w-md p-8 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
            <p className="text-lg font-medium mb-6">{t("review:today.noReviewToday")}</p>
      ...
      {showCompleted && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-20 animate-fadeIn">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full shadow-xl transform transition-all duration-300 animate-slideIn">
            ...
            <h2 className="text-2xl font-bold mb-4 text-center">{t("review:practice.practiceComplete")}！</h2>
            <div className="mb-6 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-lg">
              ...
              <div className="flex justify-between py-2">
                ...
                <span className="font-semibold">
                  {selectedTab === "unpracticed" ? t("review:today.unpracticed") + " " + t("review:history.word") : t("review:today.practiced") + " " + t("review:history.word")}
                </span>
              </div>
            </div>
            <div className="flex justify-end gap-4">
              ...
              <Button onClick={handleRestart}>{t("review:practice.practiceAgain")}</Button>
            </div>
          </div>
        </div>
      )}
