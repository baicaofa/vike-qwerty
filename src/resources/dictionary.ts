...
const medicalEnglish: DictionaryResource[] = [
  {
    id: "clinicaldiagnostics",
    name: "临床诊断学",
    description: "临床诊断学",
    category: "医学英语词典",
    tags: ["临床专业课程"],
    url: "/dicts/clinicaldiagnostics.json",
    length: 944,
    language: "en",
    languageCategory: "en",
  },
  {
    id: "humanparasitology",
    name: "人体寄生虫学",
    description: "人体寄生虫学",
    category: "医学英语词典",
    tags: ["医学基础课程"],
    url: "/dicts/humanparasitology.json",
    length: 647,
    language: "en",
    languageCategory: "en",
  },
  {
    ...
    category: "医学英语词典",
    tags: ["临床专业课程"],
    url: "/dicts/communicablediseases.json",
    length: 250,
    language: "en",
    languageCategory: "en",
  },
  ...
  },
  {
    ...
    category: "医学英语词典",
    tags: ["临床专业课程"],
    url: "/dicts/medicalethics.json",
    length: 103,
    language: "en",
    languageCategory: "en",
  },
  {
    id: "medicalimmunology",
    name: "医学免疫学",
    description: "医学免疫学",
    category: "医学英语词典",
    tags: ["医学基础课程"],
    url: "/dicts/medicalimmunology.json",
    length: 202,
    language: "en",
    languageCategory: "en",
  },
  {
    ...
    category: "医学英语词典",
    tags: ["临床专业课程"],
    url: "/dicts/medicalimaging.json",
    length: 908,
    language: "en",
    languageCategory: "en",
  },
  {
    id: "medicalmicrobiology",
    name: "医学微生物学",
    description: "医学微生物学",
    category: "医学英语词典",
    tags: ["医学基础课程"],
    url: "/dicts/medicalmicrobiology.json",
    length: 765,
    language: "en",
    languageCategory: "en",
  },
  {
    ...
    category: "医学英语词典",
    tags: ["医学基础课程"],
    url: "/dicts/medicalgenetics.json",
    length: 288,
    language: "en",
    languageCategory: "en",
  },
  ...
  },
  {
    ...
    category: "医学英语词典",
    tags: ["普通基础课程"],
    url: "/dicts/medicalstatistics.json",
    length: 1156,
    language: "en",
    languageCategory: "en",
  },
  ...
  },
  {
    ...
    category: "医学英语词典",
    tags: ["临床专业课程"],
    url: "/dicts/obstetricsandgynecology.json",
    length: 749,
    language: "en",
    languageCategory: "en",
  },
  {
    ...
    category: "医学英语词典",
    tags: ["临床专业课程"],
    url: "/dicts/laboratorydiagnostics.json",
    length: 482,
    language: "en",
    languageCategory: "en",
  },
  {
    ...
    category: "医学英语词典",
    tags: ["普通基础课程"],
    url: "/dicts/organicchemistry.json",
    length: 292,
    language: "en",
    languageCategory: "en",
  },
  {
    ...
    category: "医学英语词典",
    tags: ["临床专业课程"],
    url: "/dicts/nuclearmedicine.json",
    length: 485,
    language: "en",
    languageCategory: "en",
  },
  {
    id: "forensiclegalmedicine",
    name: "法医学",
    description: "法医学",
    category: "医学英语词典",
    tags: ["临床专业课程"],
    url: "/dicts/forensiclegalmedicine.json",
    length: 208,
    language: "en",
    languageCategory: "en",
  },
  ...
  },
  {
    ...
    category: "医学英语词典",
    tags: ["临床专业课程"],
    url: "/dicts/dermatovenereology.json",
    length: 343,
    language: "en",
    languageCategory: "en",
  },
  ...
  },
  {
    ...
    category: "医学英语词典",
    tags: ["临床专业课程"],
    url: "/dicts/psychiatry.json",
    length: 144,
    language: "en",
    languageCategory: "en",
  },
  {
    id: "histologyandembryology",
    name: "组织胚胎学",
    description: "组织胚胎学",
    category: "医学英语词典",
    tags: ["医学基础课程"],
    url: "/dicts/histologyandembryology.json",
    length: 527,
    language: "en",
    languageCategory: "en",
  },
  ...
  },
  {
    ...
    category: "医学英语词典",
    tags: ["临床专业课程"],
    url: "/dicts/otorhinolaryngology.json",
    length: 191,
    language: "en",
    languageCategory: "en",
  },
  {
    ...
    category: "医学英语词典",
    tags: ["医学基础课程"],
    url: "/dicts/pharmacology.json",
    length: 460,
    language: "en",
    languageCategory: "en",
  },
  {
    id: "basisandapplicationofcomputer",
    name: "计算机基础及应用",
    description: "计算机基础及应用",
    category: "医学英语词典",
    tags: ["普通基础课程"],
    url: "/dicts/basisandapplicationofcomputer.json",
    length: 149,
    language: "en",
    languageCategory: "en",
  },
  {
    ...
    category: "医学英语词典",
    tags: ["临床专业课程"],
    url: "/dicts/preventivemedicine.json",
    length: 376,
    language: "en",
    languageCategory: "en",
  },
  {
    id: "advancedmathematics",
    name: "高等数学",
    description: "高等数学",
    category: "医学英语词典",
    tags: ["普通基础课程"],
    url: "/dicts/advancedmathematics.json",
    length: 173,
    language: "en",
    languageCategory: "en",
  },
